...
public class Level4_EASTER_FallingTrashAnimation : MonoBehaviour {
    /*
    ...
    private static Level4_EASTER_FallingTrashAnimation _instance;
    public static Level4_EASTER_FallingTrashAnimation instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<Level4_EASTER_FallingTrashAnimation>();
            }
    ...
    private bool isFallingTrashParentHit = false;
    ...
    */
    ...
    {
        if (isFallingTrashParentHit) {
            VoiceCommandManager.instance.GoAwaySuccessVoiceInput();
