...
public class TurnAround : MonoBehaviour {
	...
	private bool hasTurnAroundStarted = false;
	private float yInitialRotation = 0f;
	...
	void Update () {
		// if (cancelSelectionAction.GetStateDown(SteamVR_Input_Sources.Any)) { // TODO: delete this else part once narrator is completed
